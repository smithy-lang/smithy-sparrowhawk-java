...
public final class Rpcv2SparrowhawkTrait extends AbstractTrait implements ToSmithyBuilder<Rpcv2SparrowhawkTrait> {

    public static final ShapeId ID = ShapeId.from("smithy.protocols#rpcv2Sparrowhawk");
    ...
    private Rpcv2SparrowhawkTrait(Builder builder) {
        super(ID, builder.getSourceLocation());
        http = List.copyOf(builder.http);
        eventStreamHttp = List.copyOf(builder.eventStreamHttp);
    }
     ...
     */
    public static Rpcv2SparrowhawkTrait fromNode(Node node) {
     ...
     */
    public static final class Builder extends AbstractTraitBuilder<Rpcv2SparrowhawkTrait, Builder> {

        private final List<String> http = new ArrayList<>();
        private final List<String> eventStreamHttp = new ArrayList<>();

        @Override
        public Rpcv2SparrowhawkTrait build() {
            return new Rpcv2SparrowhawkTrait(this);
        }
    ...
    public static final class Provider extends AbstractTrait.Provider {
        ...
        public Trait createTrait(ShapeId target, Node value) {
            Rpcv2SparrowhawkTrait result = fromNode(value);
